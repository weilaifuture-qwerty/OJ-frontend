export const m = {
  ...
  LoginPasswordNotLess: 'Password must be at least 6 characters',
  TFA_Code: 'TFA App Authentication Code',
  ...
  Status_InContest: 'In Contest',
  Status_Debugging: 'Debugging',
  Status_Reviewing: 'Reviewing',
  Status_TakingBreak: 'Taking Break',
  Status_SetYourStatus: 'Set your problem-solving status',
  Status_WhatAreYouWorkingOn: 'What are you working on?',
  Status_CustomizeColor: 'Customize color',
  Status_ChooseEmoji: 'Choose an emoji',
  Status_WhatsYourStatus: "What's your status?",
  Status_ClearAfter: 'Clear after',
  Status_Preview: 'Preview',
  Status_NoStatusMessage: 'No status message',
  Status_ClearStatus: 'Clear Status',
  Status_Save: 'Save',
  Status_DontClear: "Don't clear",
  Status_30Minutes: '30 minutes',
  Status_1Hour: '1 hour',
  Status_4Hours: '4 hours',
  Status_Today: 'Today',
  Status_ThisWeek: 'This week',
  // Daily Check In
  Daily_Check_In: 'Daily Check-in',
  Please_login_to_check_in: 'Please login to check in',
  Current_Streak: 'Current Streak',
  Best_Streak: 'Best Streak',
  Check_In_Today: 'Check In Today',
  Already_Checked_In_Today: 'Already Checked In Today!',
  Come_Back_Tomorrow: 'Come back tomorrow to continue your streak',
  Check_In_Success: 'Check-in successful! Keep it up!',
  // Problem Suggestions
  Suggested_Problems: 'Suggested Problems',
  Login_to_get_personalized_suggestions: 'Login to get personalized problem suggestions',
  Analyzing_your_practice_history: 'Analyzing your practice history...',
  Based_on_your_recent_practice: 'Based on your recent practice patterns',
  Recommended: 'Recommended',
  Submissions: 'submissions',
  View_More_Suggestions: 'View More Suggestions',
  No_suggestions_available: 'No suggestions available yet',
  Try_solving_more_problems: 'Try solving more problems to get personalized recommendations',
  Browse_Problems: 'Browse Problems',
  Suggestions_refreshed: 'Suggestions refreshed successfully',
  // Homework System
  Homework: 'Homework',
  ...
  Ask_Question_Or_Comment: 'Ask a question or leave a comment...',
  ...
  // HomeworkSummary.vue
  Please_login_to_view_homework: 'Please login to view homework',
  homework_assignments_pending: 'homework assignments pending',
  All_homework_completed: 'All homework completed!',
  ...
  No_Pending_Homework: 'You don\'t have any homework pending. Great job! 🎉',
  No_New_Assignments: 'No new homework assignments at the moment.',
  No_In_Progress: 'You\'re not working on any homework right now.',
  No_Awaiting_Grade: 'No homework awaiting grading.',
  No_Graded_To_Review: 'No graded homework to review.',
  Enjoy_Free_Time: 'Enjoy your free time or practice some problems!',
  
  // StudentHomeworkDetail.vue
  Loading_Homework_Details: 'Loading homework details...',
  Back: 'Back',
  Due: 'Due',
  Completed: 'Completed',
  Grade: 'Grade',
  ...
  Share_Your_Thoughts: 'Share your thoughts or ask questions...',
  Cancel: 'Cancel',
  ...
  Complete_All_Problems: 'Complete All Problems First',
  Homework_Submitted: 'Homework submitted successfully',
  
  // Daily Problem feature
  Daily_Problem: 'Daily Problem',
  Problem_of_the_Day: 'Problem of the Day',
  Go_to_Solve: 'Go to Solve',
  View_More_Problems: 'View More Problems',
  Great_Job: 'Great Job!',
  You_completed_todays_problem: 'You completed today\'s problem!',
  Todays_Problem: 'Today\'s Problem',
  day_streak: 'day streak',
  Want_More_Practice: 'Want More Practice?',
  Load_More_Problems: 'Load More Problems',
  Problem_Completed_Successfully: 'Problem completed successfully!'
}
